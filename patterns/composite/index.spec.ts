...
describe(`[컴포지트 패턴] 테스트`, function () {
  let seq = 1;

  let pancakeHouseMenu: MenuComponent;
  let dinerMenu: MenuComponent;
  let cafeMenu: MenuComponent;
  let dessertMenu: MenuComponent;
  let coffeeMenu: MenuComponent;
  ...
  it(`[${seq++}] 전체 메뉴 체크`, function () {
    ...
    console.log(waitress.printMenu());
  });
});
